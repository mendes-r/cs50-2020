...
const unsigned int N = 105000; //105000 ~ 73% aof all words in the large dictionary
...
{
    // Try Jenkins hash function xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
    // Try Mumur hash function xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
